...
"2024 팀네이버 신입 공채 지원 후기.md": {
	id: "2024 팀네이버 신입 공채 지원 후기.md";
  slug: "2024-팀네이버-신입-공채-지원-후기";
  body: string;
  collection: "blog";
  data: any
} & { render(): Render[".md"] };
...
"AWS Korea Associate Solutions Architect Internship 채용연계형 인턴 지원 후기.md": {
	id: "AWS Korea Associate Solutions Architect Internship 채용연계형 인턴 지원 후기.md";
  slug: "aws-korea-associate-solutions-architect-internship-채용연계형-인턴-지원-후기";
  body: string;
  collection: "blog";
  data: any
} & { render(): Render[".md"] };
...
"Google Software Engineering Intern, Summer 2024 지원 후기.md": {
	id: "Google Software Engineering Intern, Summer 2024 지원 후기.md";
  slug: "google-software-engineering-intern-summer-2024-지원-후기";
  body: string;
  collection: "blog";
  data: any
} & { render(): Render[".md"] };
...
"SAP Labs Korea Vocational Training Program Intern 지원 및 합격 후기.md": {
	id: "SAP Labs Korea Vocational Training Program Intern 지원 및 합격 후기.md";
  slug: "sap-labs-korea-vocational-training-program-intern-지원-및-합격-후기";
  body: string;
  collection: "blog";
  data: any
} & { render(): Render[".md"] };
